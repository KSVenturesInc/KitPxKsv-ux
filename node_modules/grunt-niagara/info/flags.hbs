...
--browsers (default: {{ browsers }})
    ...
    (available browsers: Chrome, ChromeCanary, Safari, Firefox,
                         Opera, PhantomJS, IE)
--chrome-flags
...
--jshint-reports-dir (default: {{ jshint-reports-dir }})
    the output directory for JSHint results in JUnit format
--complexity-reports-dir (default: {{ complexity-reports-dir }})
    the output directory for Plato complexity results
